...
import { open_sans, montserrat, reddit_mono } from '../fonts';
import Link from 'next/link';

export default function SideNav() {
	return (
		<div className={`flex flex-col h-full gap-2 w-60 ${reddit_mono.className}`}>
			...
			<div className='hidden bg-gray-100 w-full rounded-md grow h-auto md:block'></div>
